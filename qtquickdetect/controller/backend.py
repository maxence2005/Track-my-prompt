...
class Backend(QObject):
    ...
    def __init__(self, media_model: DatabaseManagerMedia, row, im_pro: ImageProvider):
        super().__init__()
        self.media_model = media_model
        self.image_provider = im_pro
        self._shared_variable = {"settingsMenuShowed": False, "Erreur": False, "Menu": True, "Chargement" : False, "Camera" : False}
