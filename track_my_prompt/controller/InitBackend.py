...
class Controller(QObject):
    ...
    def start(self):
        ...
        self._backend = Backend(self._database_media, self._database_media._media_model.rowCount(), db_path, self._database_manager_historique, self.frame_provider, ia_method, api_key, transcription_mode, self._database_manager.encyclopediaModel)
